...
const Board = () => {
  ...
  const { randomBalls, restartHandler, completed } = useContext(ballsContext);
  ...
  return (
    <div className='board-container'>
      <header className='header'>
        ...
        <Link to='/board' onClick={()=>restartHandler()} ><button className='header-controls'>Reastart</button></Link>

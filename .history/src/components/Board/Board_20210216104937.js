...
const Board = (props) => {
  ...
  return (
    <div className='board-container'>
      ...
      <ul>
        <li className='header-controls' onClick={() => window.location.reload()}>New game</button>
        <li className='header-controls' onClick={() => restartHandler()}>Restart</button>
        <li className='header-controls' onClick={() => undoHandler()}>Undo {undoCount}</button>
        </ul>
      </header>

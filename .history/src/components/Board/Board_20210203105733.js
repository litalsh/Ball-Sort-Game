...
const Board = () => {
  ...
  const restartHandler = () => {
    setRandomBalls(initialRandomBall)
  ...
  return (
    <div className='board-container'>
      <header className='header'>
        ...
        <Link to='/board' key={initialRandomBall.id} onClick={()=>shuffleBalls(initialRandomBall.num)} ><button className='header-controls'>Restart</button></Link>

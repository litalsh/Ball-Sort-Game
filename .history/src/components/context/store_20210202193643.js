...
const BallsContextProvider = (props) => {
  ...
  const undoHandler = () => {
    if (undoCount === 0){
      ...
      let undoItem = tempRandomBalls.splice(tempRandomBalls[undoMoves[undoMoves.length-1].newIndex][tempRandomBalls[undoMoves[undoMoves.length-1].newIndex].length], 1);

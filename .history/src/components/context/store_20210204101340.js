...
const BallsContextProvider = (props) => {
  ...
  const [initialRandomBalls, setInitialRandomBalls] = useLocalStorage('initialRandomBalls', []);
  ...
  const shuffle = (array) => {
    ...
    setInitialRandomBalls(shuffled.concat(emptyTubes));
  }
  ...
  const restartHandler = () => {
    setRandomBalls([...initialRandomBalls])
  }
